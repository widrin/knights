...
func ToInt32(value interface{}) int32 {
	...
	case string:
		...
		if err != nil {
			log.Warn("value %v toint32: %v", value, err)
		}
		return int32(ret)
	}
	log.Warn("ToInt32 类型没有定义:%v  %T", value, value)
	return 0
}
func ToInt64(value interface{}) int64 {
	...
	log.Warn("ToInt64 类型没有定义:%v :%T", value, value)
	return 0
}
...
func ToString(value interface{}) string {
	...
	default:
		...
		log.Warn("ToString 类型没有定义:%v>>%T", value, value)
		ret, err := json.Marshal(value)
		if err != nil {
			log.Warn("ToString Marshal:%v>>%v", err, value)
		}
		return string(ret)
	}
	return ""
...
func ToFloat64(value interface{}) float64 {
	...
	case string:
		...
		if err != nil {
			log.Warn("value %v ToFloat64: %v", value, err)
		}
		return ret
	}
	log.Warn("ToFloat64 类型没有定义:%v>>%T", value, value)
	return 0
}
...
func ToTime(value interface{}) time.Time {
	...
	case string:
		...
		if err != nil {
			log.Warn("toTime :%v>>%v", value, err)
			return defaultTime
		}
		return ret
	}
	log.Warn("ToTime 类型没有定义:%v>>%T", value, value)
	return defaultTime
}
func ToBytes(value interface{}) []byte {
	...
	log.Warn("ToBytes 类型没有定义:%v>>%T", value, value)
	return []byte{}
}
